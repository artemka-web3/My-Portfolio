              ...
              <div className="about-content">
                ...
                <div className="about-text">
                  <p>
                    Привет! &#128075; 
                    <br/>
                    Я студент первого курса Центрального Университета, увлеченный бэкенд-разработкой
                    <br/>
                    Работаю фрилансером уже 2 года, создаю телеграм-ботов, юзер-ботов и RESTful API
                    <br/>
                    Мне не терпится получить больше опыта и внести свой вклад в интересные проекты
                    <br/>
                    Я очень мотивирован и готов привнести в вашу команду свою энергию и преданность делу.
