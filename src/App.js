              ...
              <div className="about-content">
                ...
                <div className="about-text">
                  <p>
                    Привет! &#128075; 
                    <br/>
                    Я студент первого курса университета, увлеченный бэкенд-разработкой
                    <br/>
                    Я работаю фрилансером уже около года, решая задачи разного уровня и постоянно совершенствуя свои навыки
                    <br/>
                    Мне не терпится получить больше опыта и внести свой вклад в интересные проекты
                    <br/>
                    Я ответственен, мотивирован и готов привнести в вашу команду свою энергию и преданность делу.
